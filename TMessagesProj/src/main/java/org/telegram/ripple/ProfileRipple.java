...
public class ProfileRipple {

    private static Paint paint;

    public static void drawRipple(Canvas canvas, float w, float h, View avatarContainer) {
        if (paint == null) {
            paint = new Paint();
        ...
        if (avatarContainer.getScaleY() < 1.1f) {
            ...
            if (avatarContainer.getY() > 0) {
                ...
                float ly = avatarContainer.getY() + avatarContainer.getMeasuredHeight() * avatarContainer.getScaleY();
