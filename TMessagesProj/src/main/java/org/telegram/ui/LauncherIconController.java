...
public class LauncherIconController {
    ...
    public enum LauncherIcon {
        DEFAULT("DefaultIcon", R.drawable.icon_background_sa, R.mipmap.icon_ta_foreground, R.string.AppIconDefault),
        ...
        public ComponentName getComponentName(Context ctx) {
            if (componentName == null) {
                componentName = new ComponentName(ctx.getPackageName(), "com.theerasan.messenger." + key);
            }
